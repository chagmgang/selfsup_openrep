...
@BACKBONES.register_module()
class LargeConvnext(ConvNeXt):

    def __init__(self, **kwargs):

        super(LargeConvnext, self).__init__(
            depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536])


@BACKBONES.register_module()
class XLargeConvnext(ConvNeXt):

    def __init__(self, **kwargs):

        super(XLargeConvnext, self).__init__(
