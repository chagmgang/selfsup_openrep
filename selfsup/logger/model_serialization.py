...
# From https://github.com/facebookresearch/maskrcnn-benchmark/
#              blob/master/maskrcnn_benchmark/utils/model_serialization.py
...
def align_and_update_state_dicts(model_state_dict, loaded_state_dict):
    ...
    for idx_new, idx_old in enumerate(idxs.tolist()):
        ...
        if not torch.equal(
                torch.tensor(model_state_dict[key].shape),
                torch.tensor(loaded_state_dict[key_old].shape),
        ):
            continue
