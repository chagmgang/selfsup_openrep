...
from selfsup import __version__
from selfsup.apis import init_random_seed, set_random_seed, train_model
from selfsup.datasets import build_dataset
from selfsup.models import build_algorithm
from selfsup.utils import collect_env, get_root_logger, setup_multi_processes
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        ...
        cfg.checkpoint_config.meta = dict(
            selfsup_version=__version__, config=cfg.pretty_text)
